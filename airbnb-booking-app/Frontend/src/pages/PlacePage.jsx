          ...
          <div>
            {place.photos?.[0] && (
              <div className='aspect-square object-cover rounded-2xl overflow-hidden'>
                <img onClick={() => setShowAllPhotos(true)} className='cursor-pointer' src={place.photos?.[0]} alt="" />
              </div>
            )}
          </div>
          <div className='flex flex-col'>
            {place.photos?.[1] && (
              <img onClick={() => setShowAllPhotos(true)} className=' cursor-pointer rounded-tr-2xl' src={place.photos?.[1]} alt="" />
            )}
            <div className='overflow-hidden'>
              {place.photos?.[2] && (
                <img onClick={() => setShowAllPhotos(true)} className= 'cursor-pointer relative top-2' src={place.photos?.[2]} alt="" />
              )}
            </div>
          </div>
        </div>
